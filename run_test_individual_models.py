...
def experiment(args):
    ...
    train_queries_by_user, test_queries_by_user, _ = read_queries(
        args.data_filename,
    ...
    output_file = generate_filepath(
        args.output_dir, f"coin_flip_individual_expt", "csv"
    )
...
if __name__ == "__main__":
    ...
    if args.DEBUG:
        ...
        arg_str += " --max-opt-loops 4"
        arg_str += " --num-sobol-points 500"
        arg_str += " --num-gpei-points 0"
        arg_str += " --opt-time-limit 300"
        arg_str += " --seed 0"
